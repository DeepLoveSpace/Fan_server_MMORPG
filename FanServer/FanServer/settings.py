"""
Django settings for FanServer project.
...
SECRET_KEY = 'django-insecure-zw&ns&53oq7yq6u@58k^x14d*j-dh6b!dyw&t$^c&yyfkxxjeb'
...
WSGI_APPLICATION = 'FanServer.wsgi.application'
...
AUTH_USER_MODEL = 'bulletin_board.User'
